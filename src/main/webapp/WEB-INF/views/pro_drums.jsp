...
<head>
    ...
    <title>Animated SVG Drum Kit | jq22</title>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/assets/svgDrums/css/normalize.css">
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/assets/svgDrums/fonts/font-awesome-4.3.0/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/assets/svgDrums/css/styles.css">
    <!--[if IE]>
...
<audio id="Big-Rack-Tom-Audio" preload="auto">
    <source src="<%=request.getContextPath()%>/assets/svgDrums/mp3/Big-Rack-Tom.mp3" type="audio/mp3">
</audio>
<audio id="Crash-Audio" preload="auto">
    <source src="<%=request.getContextPath()%>/assets/svgDrums/mp3/Crash.mp3" type="audio/mp3">
</audio>
<audio id="Floor-Tom-Audio" preload="auto">
    <source src="<%=request.getContextPath()%>/assets/svgDrums/mp3/Floor-Tom.mp3" type="audio/mp3">
</audio>
<audio id="Hi-Hat-Closed-Audio" preload="auto">
    <source src="<%=request.getContextPath()%>/assets/svgDrums/mp3/Hi-Hat-Closed.mp3" type="audio/mp3">
</audio>
<audio id="Kick-Audio" preload="auto">
    <source src="<%=request.getContextPath()%>/assets/svgDrums/mp3/Kick.mp3" type="audio/mp3">
</audio>
<audio id="Small-Rack-Tom-Audio" preload="auto">
    <source src="<%=request.getContextPath()%>/assets/svgDrums/mp3/Small-Rack-Tom.mp3" type="audio/mp3">
</audio>
<audio id="Snare-Audio" preload="auto">
    <source src="<%=request.getContextPath()%>/assets/svgDrums/mp3/Snare.mp3" type="audio/mp3">
</audio>
<script src="http://www.jq22.com/jquery/jquery-1.10.2.js"></script>
<script src="<%=request.getContextPath()%>/assets/svgDrums/js/TweenMax.min.js"></script>
<script src="<%=request.getContextPath()%>/assets/svgDrums/js/script.js"></script>
</body>
</html>