var showToast=function(object) {
    ...
    try{
        ...
        popToastHtml += `<div class="pop-toast" style="position: fixed;  width: 340px;  height: 200px;  text-align: center;background-color: gray;border-radius: 10px;box-shadow: 0 2px 8px #555 ;right: 50%;top: 50%;margin: -100px -70px 0px 0;z-index: 9999999999999999999999">`;
        if(image){
            popToastHtml += `<img src="${image}" style="width: 50px;margin-top: 12px;">`
            popToastHtml += ` <div class="toast-tip" style=" font-size: 16px;  color: #fff;  height: 100px;overflow: hidden;width:200px; word-wrap: break-word; text-align: center;padding: 0 5px ;margin-bottom: 10px;">${tipTxt}</div>
                              </div></div>`;
        }
        else{
            if(icon=="none"){
                popToastHtml += ` <img  style="width: 50px;margin-top: 12px;display: none">`
                popToastHtml += ` <div class="toast-tip" style=" font-size: 16px;  color: #fff;  height: 100px;overflow: hidden;width:200px; word-wrap: break-word; text-align: center;padding: 0 5px ;margin-top: 45px;margin-left: 80px ">${tipTxt}</div>
                              </div></div>`;
            }
            else {
                if(icon=="frown"){
                    popToastHtml += `<img src="assets/images/icon/logo.png" width="140px" height="50px"><br><img src="assets/images/icon/frown.png" width="50px" height="50px">`;
                }
                else if (icon=="meh"){
                    popToastHtml += `<img src="assets/images/icon/logo.png" width="140px" height="50px"><br><img src="assets/images/icon/meh.png" width="50px" height="50px">`;

                }else if (icon=="smile"){
                    popToastHtml += `<img src="assets/images/icon/logo.png" width="140px" height="50px"><br><img src="assets/images/icon/smile.png" width="50px" height="50px">`;
                }
                else if(icon=="loading"){
                    popToastHtml += `<div id="xsw_canvas" style="140px;height: 60px;"></div>`;
                }
                popToastHtml += ` <div class="toast-tip" style=" font-size: 16px;  color: #fff; height: 100px;overflow: hidden;width:200px; word-wrap: break-word; text-align: center;padding: 0 5px ;margin-bottom: 10px;margin-top: 20px;margin-left: 80px">${tipTxt}</div>
                              </div></div>`;
            }
