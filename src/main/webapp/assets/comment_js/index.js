	...
	$.fn.barrage = function(opt){
		...
		M.bgColors = ['#181d4b','#edbce7','#c092e4','#9b92e4','#92bae4','#92d9e4','#92e4bc','#a9e492','#d9e492','#e4c892']; //随机背景色数组
		Obj.arrEle = []; //预计存储dom集合数组
		M.barrageBox = $('<div id="barrage" style="z-index:999;max-width:50%;position:'+settings.position+';'+M.vertical+':0;'+M.horizontal+':0;"></div>'); //存所有弹幕的盒子
		M.timer = null; 
